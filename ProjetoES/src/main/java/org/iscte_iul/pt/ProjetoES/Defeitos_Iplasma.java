...
public class Defeitos_Iplasma {
	...
	/**
	 * Neste metodo utilizando os dados e iPlasma Se ambos forem true, passa a
	 * existir um DCI Se os dados forem false e o iPlasma true, existe um DII Se
	 * ambos forem false, cria-se um ADII Se nenhum deste acontecer, passa a existir
	 * mais um ADDII
	 * 
	 */
